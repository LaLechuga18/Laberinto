...
# Cómo Ejecutar
Necesitas Python 3.x instalado. La librería tkinter generalmente viene preinstalada con Python.
Pasos:
1. Guarda el código: Asegúrate de que el archivo Laberinto_Final.py esté en tu computadora.
2. Ejecuta el script: python Laberinto_Final.py
3. Uso:
- Presiona "Empezar".
- Ingresa un tamaño cuadrado (por ejemplo, 10 filas y 10 columnas). El mínimo es 6x6.
- Presiona "Generar Laberinto".
- Presiona "Resolver Laberinto" para ver la solución automática.
